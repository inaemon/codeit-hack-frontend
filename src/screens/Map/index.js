                                ...
                                {reviews.map((review, index) => (
                                    <li key={index}>
                                        {review.User && review.User.userProfilePic && (
                                            <img src={review.User.userProfilePic} alt={`${review.User.name}'s profile`} style={{ width: '30px', borderRadius: '50%' }} />
                                        )}<br />
                                        <strong>닉네임: {review.User ? review.User.name : 'Unknown'}</strong><br />
                                        평점: {review.rating}<br />
                                        리뷰: {review.comment}
                                    </li>
                                ))}
